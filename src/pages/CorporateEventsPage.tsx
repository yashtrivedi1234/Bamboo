...
import { Briefcase, Globe, BarChart, Shield } from 'lucide-react';

const corporateServices = [
  {
    title: 'Annual Summits',
    description: 'High-impact conferences and summits designed for global leaders and industry pioneers.',
    icon: <Globe size={24} />,
  },
  {
    title: 'Product Launches',
    description: 'Immersive brand experiences that captivate audiences and dominate the market narrative.',
    icon: <Briefcase size={24} />,
  },
  {
    title: 'Strategic Offsites',
    description: 'Curated retreats that foster innovation, leadership alignment, and team synergy.',
    icon: <BarChart size={24} />,
  },
  {
    title: 'Gala Dinners',
    description: 'Sophisticated black-tie events that celebrate milestones with unparalleled elegance.',
    icon: <Shield size={24} />,
  },
];

export const CorporateEventsPage: React.FC = () => {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      <div className="max-w-7xl mx-auto flex flex-col space-y-20">
        <div className="flex flex-col space-y-6">
          ...
          <h2 className="text-5xl md:text-8xl font-bold text-white leading-tight tracking-tighter">
            Architecting <span className="text-accent-green italic">Corporate</span> Legacies.
          </h2>
        </div>
        ...
        <div className="relative h-[600px] rounded-[60px] overflow-hidden">
          ...
          <div className="absolute bottom-12 left-12 max-w-lg">
            <p className="text-white text-2xl font-medium leading-relaxed italic">
              "Precision is the foundation of luxury. We don't just plan events; we engineer environments where business thrives."
            </p>
          </div>
        </div>
      </div>
